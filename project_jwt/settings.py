...
TOKEN_SECRET_KEY = os.getenv('ACCESS_TOKEN_SECRET_KEY')
TOKEN_SECRET_KEY = os.getenv('REFRESH_TOKEN_SECRET_KEY')

ACCESS_TOKEN_ALGORITHMS = 'HS256'
REFRESH_TOKEN_ALGORITHMS = 'HS256'
